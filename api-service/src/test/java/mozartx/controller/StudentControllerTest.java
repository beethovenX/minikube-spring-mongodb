...
public class StudentControllerTest {
    ...
    // Skip these Tests before running the if you are on local host.
    @Test
    public void testCreateStudent() {
        ...
        Student student = new Student("1", "Aman Kalotra", "IT", courses);
        ...
        assertEquals(studentObj.getName(), "Aman Kalotra");
    }
	...
	public <E> void testGetStudentsByName() {
        ResponseEntity<List<Student>> responseEntity = restTestTemplate.exchange(
            "http://localhost:" + port + "/students?name=Aman",
            HttpMethod.GET, null, new ParameterizedTypeReference<List<Student>>() {
        });
        assertEquals(responseEntity.getStatusCode(), HttpStatus.OK);
    ...
    public void testGetStudentPageByName() {
        ResponseEntity<List<Student>> responseEntity = restTestTemplate.exchange(
            "http://localhost:" + port + "/students/page?name=Aman Kalotra",
            HttpMethod.GET, null, new ParameterizedTypeReference<List<Student>>() {
        });
        assertEquals(responseEntity.getStatusCode(), HttpStatus.OK);
